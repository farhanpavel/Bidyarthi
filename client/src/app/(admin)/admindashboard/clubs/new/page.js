"use client";
import { UserPlus, Loader2, SquarePen } from "lucide-react";
    ...
    <div>
      <div className="p-9 space-y-2">
        <div className="flex gap-x-2 items-center text-black">
          ...
          <h1 className="text-2xl font-bold font-bangla">ক্লাব এন্ট্রি ফর্ম</h1>
        </div>
        <p className="text-xs text-[#4a4a4a] border-black  border-b-[2px] pb-4 font-bangla">
        আপনার নতুন যাত্রা শুরু করুন এবং আমাদের ক্লাবের অংশ হন!
        </p>
        <div>
          <Card className="border-[1px] border-gray-300">
            <CardHeader className="space-y-4">
              <CardTitle className="font-bangla">ক্লাব বিবরণ</CardTitle>
              <CardDescription className="font-bangla">
                দয়া করে ক্লাবের প্রয়োজনীয় তথ্য
                পূরণ করুন।
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="grid w-full items-center gap-4">
                  ...
                  <div className="flex flex-col space-y-6">
                    ...
                    <div className="space-y-2 ">
                      ...
                      <div className="space-y-2">
                        <Label className="text-xs font-bangla" htmlFor="address">
                          ঠিকানা
                        </Label>
                        <Input
                          id="address"
