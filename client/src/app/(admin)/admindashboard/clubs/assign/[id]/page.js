...
export default function Page() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await fetch(`${url}/api/user/Clubpresident/deactive`, {
        method: "GET",
        headers: {
    ...
    const assignData = async () => {
      const response = await fetch(
        `${url}/api/user/Clubpresident/${id}/active`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleAssign = async (user_id) => {
    try {
      const response = await fetch(`${url}/api/club/${user_id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
    <div className="p-9 space-y-2">
      <div className="flex gap-x-2 items-center text-black">
        ...
        <h1 className="text-2xl font-bold font-bangla">ক্লাব প্রবেশাধিকার ব্যবস্থাপনা</h1>
      </div>
      <p className="text-xs text-[#4a4a4a] border-black  border-b-[2px] pb-4 font-bangla">
      ক্লাব প্রবেশে সহায়তার জন্য যোগাযোগের তথ্য।
      </p>
      <Card className="border-[1px] border-gray-300">
        <CardHeader>
          <CardTitle className="text-lg font-bangla">ক্লাব প্রবেশ ব্যবস্থাপনা</CardTitle>
          <CardDescription className="text-xs font-bangla">
          ক্লাব প্রবেশাধিকার পরিচালনা করুন
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <Card>
                <CardHeader>
                  <div className="py-3 text-[#4a4a4a] flex justify-between text-xs border-b-[1px] border-gray-300">
                    <div>
                      <h1 className="font-bangla">ক্লাব নির্বাচন করুন</h1>
                    </div>
                    <div>
              ...
              <Card>
                <CardHeader>
                  <div className="py-3 text-[#4a4a4a] flex justify-between text-xs border-b-[1px] border-gray-300">
                    ...
                    <div>
                      <h1 className="font-bangla">ক্লাব থেকে</h1>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
