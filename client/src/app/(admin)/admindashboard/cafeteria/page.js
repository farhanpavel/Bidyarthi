"use client";
import { CalendarCheck, LayoutDashboard, Salad } from "lucide-react";
    ...
    <div>
      <div className="p-9 space-y-2">
        <div className="flex gap-x-2 items-center text-black">
          <Salad className="text-3xl" />
          <h1 className="text-2xl font-bold font-bangla">খাবার ব্যবস্থাপনা প্যানেল</h1>
        </div>
        <p className="text-xs text-[#4a4a4a] border-black  border-b-[2px] pb-4 font-bangla">
        কাস্টমার অর্ডার ও বিলিং পরিচালনা করুন
        </p>
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                {[5, 10, 20, 30, 40, 50].map((pageSize) => (
                  <option key={pageSize} value={pageSize} className="text-sm font-bangla">
