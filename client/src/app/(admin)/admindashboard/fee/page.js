...
function Page() {
  ...
  // Function to calculate days remaining or expired
  const getDaysStatus = (feeDate) => {
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-end mb-5">
          <Button
            onClick={() => {
              router.push("/admindashboard/fee/new");
            }}
          >
            যুক্ত করুন
          </Button>
                ...
                >
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="pt-4">
                      <Button
                        onClick={() => {
                          router.push(`/admindashboard/fee/details/${fee.id}`);
                        }}
