...
export default function Snake() {
  const benefits = [
    ...
    },
    {
      ...
      title: "সহজ কুইজ ইন্টিগ্রেশন",
      description:
        "বিদ্ধার্থী আপনার বিদ্যমান সিস্টেমগুলির সাথে মসৃণভাবে ইন্টিগ্রেট করে, কুইজ এবং শিক্ষার্থীদের পরিচালনা করার প্রক্রিয়া সরল করে। এই ইন্টিগ্রেশনটি নিশ্চিত করে যে শিক্ষক এবং শিক্ষার্থীরা কোনও ঝামেলা ছাড়াই সর্বশেষ কুইজ এবং পরীক্ষার সংস্থানগুলি অ্যাক্সেস করতে পারে।",
      position: "left",
